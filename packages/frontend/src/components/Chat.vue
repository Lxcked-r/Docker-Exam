...
const socket = io("ws://172.21.22.153:3001");
...
const setSocketMessage = (userID, text, channelID) => {
    const messageData = {userID: userID, text: text, channelID: channelID};
...
const sendNewMessage = async () => {
    ...
    setSocketMessage(props.userID, messageInput.value.value, props.channelID);
...
<div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
    <div class="relative flex">
        ...
        <input ref="messageInput" type="text" placeholder="Write your message!" class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3">
